...
export const likeUnlikePost = async (req, res) => {
  try {
    ...
    if (userLikedPost) {
      ...
      res
        .status(200)
        .json({ likes: updatedLikes, likeCount: updatedLikes.length });
    } else {
      // Like post
...
// ... (keep all existing controller functions like createPost, deletePost, etc.)

// ⬇️ ADD THIS NEW FUNCTION TO TOGGLE A BOOKMARK
...
// ⬇️ ADD THIS NEW FUNCTION TO GET BOOKMARKED POSTS
export const getBookmarkedPosts = async (req, res) => {
  ...
  try {
    ...
    // Find posts where the bookmarks array contains the user's ID
